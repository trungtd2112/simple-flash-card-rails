...
class CardSetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create card_set" do
    assert_difference('CardSet.count') do
      post card_sets_url, params: { card_set: { name: @card_set.name, user_id: @card_set.user_id } }
    end
  ...
  test "should update card_set" do
    patch card_set_url(@card_set), params: { card_set: { name: @card_set.name, user_id: @card_set.user_id } }
